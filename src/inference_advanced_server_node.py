...
class InferenceServer():
	def __init__(self, sub_topic, pub_topic):
		self.detec_graph, self.category = obj_det_fun_advanced.objdetect()
		...
		self._as = actionlib.SimpleActionServer("inference_server",
                                            inference_server.msg.InferenceAdvancedAction,
	...
	def execute_cb(self, goal):
		...
		result = inference_server.msg.InferenceAdvancedResult()
		self.inference_output, num_detected, detected_classes, detected_scores, detected_boxes = obj_det_fun_advanced.detect(self.sess, self.detec_graph, self.category, self.inference_input)
...
if __name__ == '__main__':
	...
	obj_det_fun_advanced.loadmodel()
